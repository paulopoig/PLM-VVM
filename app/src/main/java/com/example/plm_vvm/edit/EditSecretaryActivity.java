...
public class EditSecretaryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_edit_secretary);


        secretary = (Secretary) getIntent().getSerializableExtra("secretary");
...
//        editParty.setText(part);
        ...
        editName.setText(secretary.getName());
        editParty.setText(secretary.getParty());
        editPosition.setText(secretary.getPosition());
//
//        String uid = Objects.requireNonNull(FirebaseAuth.getInstance().getCurrentUser()).getUid();
        ...
        updateBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Secretary s = new Secretary(name, party, position);
...
//                }
                    ...
                    firebaseFirestore.collection("Secretary")
                            ...
                            .addOnSuccessListener(new OnSuccessListener<Void>() {
                                ...
                                public void onSuccess(Void unused) {
                                    startActivity(new Intent(EditSecretaryActivity.this, HomeActivity.class));
                                    Toast.makeText(EditSecretaryActivity.this, "Candidate Updated", Toast.LENGTH_SHORT).show();
                                    finish();
                                }
                            });
        ...
        deleteBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                AlertDialog.Builder builder =  new  AlertDialog.Builder(EditSecretaryActivity.this);
        ...
        firebaseFirestore.collection("Secretary")
                ...
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        ...
                        {
                            startActivity(new Intent(EditSecretaryActivity.this, HomeActivity.class));
                            Toast.makeText(EditSecretaryActivity.this, "Candidate Deleted", Toast.LENGTH_SHORT).show();
                            finish();
                        }

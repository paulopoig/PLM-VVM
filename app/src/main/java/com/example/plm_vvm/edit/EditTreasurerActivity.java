...
public class EditTreasurerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_edit_treasurer);


        treasurer = (Treasurer) getIntent().getSerializableExtra("treasurer");
...
//        editParty.setText(part);
        ...
        editName.setText(treasurer.getName());
        editParty.setText(treasurer.getParty());
        editPosition.setText(treasurer.getPosition());
//
//        String uid = Objects.requireNonNull(FirebaseAuth.getInstance().getCurrentUser()).getUid();
        ...
        updateBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Treasurer t = new Treasurer(name, party, position);
...
//                }
                    ...
                    firebaseFirestore.collection("Treasurer")
                            ...
                            .addOnSuccessListener(new OnSuccessListener<Void>() {
                                ...
                                public void onSuccess(Void unused) {
                                    startActivity(new Intent(EditTreasurerActivity.this, HomeActivity.class));
                                    Toast.makeText(EditTreasurerActivity.this, "Candidate Updated", Toast.LENGTH_SHORT).show();
                                    finish();
                                }
                            });
        ...
        deleteBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                AlertDialog.Builder builder =  new  AlertDialog.Builder(EditTreasurerActivity.this);
        ...
        firebaseFirestore.collection("Treasurer")
                ...
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        ...
                        {
                            startActivity(new Intent(EditTreasurerActivity.this, HomeActivity.class));
                            Toast.makeText(EditTreasurerActivity.this, "Candidate Deleted", Toast.LENGTH_SHORT).show();
                            finish();
                        }

...
public class EditPresidentAdapter extends RecyclerView.Adapter<EditPresidentAdapter.ViewHolder> {

    private Context context;
    private List<President> list;

    public EditPresidentAdapter(Context context, List<President> list) {
    ...
    @NonNull
    @Override
    public EditPresidentAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.candidate_layout, parent, false);
        return new EditPresidentAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull EditPresidentAdapter.ViewHolder holder,  @SuppressLint("RecyclerView") int position) {
        ...
        holder.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                President president = list.get(holder.getAdapterPosition());
                Intent intent = new Intent(context, EditPresidentActivity.class); // ETO!

...
import com.example.plm_vvm.extension.VotingSecretaryActivity;
...
public class SecretaryAdapter extends RecyclerView.Adapter<SecretaryAdapter.Viewholder> {
    ...
    public SecretaryAdapter(Context context, List<Secretary> list) {
    ...
    public SecretaryAdapter.Viewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new SecretaryAdapter.Viewholder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull SecretaryAdapter.Viewholder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(context, VotingSecretaryActivity.class); // ETO!

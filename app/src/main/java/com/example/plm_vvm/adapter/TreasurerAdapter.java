...
import com.example.plm_vvm.extension.VotingTreasurerActivity;
...
public class TreasurerAdapter extends RecyclerView.Adapter<TreasurerAdapter.Viewholder> {


    private Context context;
    private List<Treasurer> list;

    public TreasurerAdapter(Context context, List<Treasurer> list) {
    ...
    @NonNull
    @Override
    public TreasurerAdapter.Viewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.candidate_layout, parent, false);
        return new TreasurerAdapter.Viewholder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull TreasurerAdapter.Viewholder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(context, VotingTreasurerActivity.class); // ETO!

...
public class VicePresidentResultAdapter extends RecyclerView.Adapter<VicePresidentResultAdapter.ViewHolder> {

    private Context context;
    private List<VicePresident> list;
    private FirebaseFirestore firebaseFirestore;

    public VicePresidentResultAdapter(Context context, List<VicePresident> list) {
    ...
    @NonNull
    @Override
    public VicePresidentResultAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.candidate_result_layout, parent, false);
        return new VicePresidentResultAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull VicePresidentResultAdapter.ViewHolder holder, @SuppressLint("RecyclerView")  int position) {
        ...
        firebaseFirestore.collection("Vice-President/"+list.get(position).getId()+"/Vote")
                .addSnapshotListener(new EventListener<QuerySnapshot>() {
                    ...
                    public void onEvent(@Nullable QuerySnapshot documentSnapshots, @Nullable FirebaseFirestoreException error) {
                        ...
                        if(!documentSnapshots.isEmpty())
                        {
                            ...
                            VicePresident vicePresident = list.get(position);
                            vicePresident.setCount(count);
                            list.set(position, vicePresident);

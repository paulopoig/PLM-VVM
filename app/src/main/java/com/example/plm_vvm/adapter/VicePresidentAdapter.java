...
import com.example.plm_vvm.extension.VotingVicePresidentActivity;
...
public class VicePresidentAdapter extends RecyclerView.Adapter<VicePresidentAdapter.Viewholder> {

    private Context context;
    private List<VicePresident> list;

    public VicePresidentAdapter(Context context, List<VicePresident> list) {
    ...
    @NonNull
    @Override
    public VicePresidentAdapter.Viewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.candidate_layout, parent, false);
        return new VicePresidentAdapter.Viewholder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull VicePresidentAdapter.Viewholder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(context, VotingVicePresidentActivity.class); // ETO!

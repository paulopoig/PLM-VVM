...
public class SecretaryResultAdapter extends RecyclerView.Adapter<SecretaryResultAdapter.ViewHolder> {
    ...
    public SecretaryResultAdapter(Context context, List<Secretary> list) {
    ...
    @NonNull
    @Override
    public SecretaryResultAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.candidate_result_layout, parent, false);
        return new SecretaryResultAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull SecretaryResultAdapter.ViewHolder holder,  @SuppressLint("RecyclerView") int position) {
        ...
        firebaseFirestore.collection("Secretary/"+list.get(position).getId()+"/Vote")
                .addSnapshotListener(new EventListener<QuerySnapshot>() {
                    ...
                    public void onEvent(@Nullable QuerySnapshot documentSnapshots, @Nullable FirebaseFirestoreException error) {
                        ...
                        if(!documentSnapshots.isEmpty())
                        {
                            ...
                            Secretary secretary = list.get(position);
                            secretary.setCount(count);
                            list.set(position, secretary);
...
//        });
    ...
    public void filterList(ArrayList<Secretary> filteredList){
        list = filteredList;
        notifyDataSetChanged();
    }

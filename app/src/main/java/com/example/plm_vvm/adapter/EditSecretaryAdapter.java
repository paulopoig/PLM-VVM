...
public class EditSecretaryAdapter extends RecyclerView.Adapter<EditSecretaryAdapter.ViewHolder> {


    private Context context;
    private List<Secretary> list;

    public EditSecretaryAdapter(Context context, List<Secretary> list) {
    ...
    @NonNull
    @Override
    public EditSecretaryAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.candidate_layout, parent, false);
        return new EditSecretaryAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull EditSecretaryAdapter.ViewHolder holder, @SuppressLint("RecyclerView")  int position) {
        ...
        holder.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Secretary secretary = list.get(holder.getAdapterPosition());
                Intent intent = new Intent(context, EditSecretaryActivity.class); // ETO!

...
import com.example.plm_vvm.edit.ChooseEditActivity;
...
public class HomeActivity extends AppCompatActivity {
    ...
    private ImageView enlistBtn, voteBtn, tallyBtn, editBtn;
            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                ...
                if(task.isSuccessful())
                {
                    ...
                    else
                    {
                        ...
                        tallyBtn.setVisibility(View.VISIBLE);
                    }
//                    else
//                    {
...
//                    }
        ...
        voteBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                startActivity(new Intent(HomeActivity.this, ChooseCandidateVoteActivity.class));
            }
        });
        ...
        tallyBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(HomeActivity.this, ChooseResultActivity.class));
            }
        });
        ...
        editBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(HomeActivity.this, ChooseEditActivity.class));
            }
        });
    }
}
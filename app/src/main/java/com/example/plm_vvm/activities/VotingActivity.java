    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Btnvote.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                firebaseFirestore.collection("Candidates/"+id+"/Vote")
                        .document(uid)
                        .set(candidateMap)
                        .addOnCompleteListener(new OnCompleteListener<Void>() {
                            ...
                            public void onComplete(@NonNull Task<Void> task) {
                                ...
                                {
                                    Toast.makeText(VotingActivity.this, "Voted Counted Successfully.", Toast.LENGTH_SHORT).show();
                                    startActivity(new Intent(VotingActivity.this, ResultActivity.class));
                                    finish();
                                }
                                else
                                {
                                    Toast.makeText(VotingActivity.this, "Vote Unsucessful.", Toast.LENGTH_SHORT).show();
                                }
